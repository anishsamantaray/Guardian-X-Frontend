  ...
  return (
    <div className="flex flex-col items-center">
      <motion.button
        ...
        className="w-32 h-32 rounded-full bg-gradient-to-br from-[#FF5151] to-[#884DFF] shadow-lg flex flex-col items-center justify-center text-white select-none focus:outline-none"
      >
